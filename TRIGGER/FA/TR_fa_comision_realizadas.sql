...
BEGIN
	IF(SELECT COUNT(1) FROM temp_registroMigracion where nombre_table = 'fa_comision_realizadas' AND tipo=@tipo AND codigo=@codigo AND codigo2=@codigo2 AND codigo3=@codigo3 AND codigo4=@codigo4) = 0
